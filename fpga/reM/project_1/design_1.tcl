...
proc create_root_design { parentCell } {
  ...
  set cnn_0 [ create_bd_cell -type ip -vlnv user.org:user:cnn:1.0 cnn_0 ]
  ...
  connect_bd_intf_net -intf_net axi_smc_M06_AXI [get_bd_intf_pins axi_smc/M06_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins cnn_0/en]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins cnn_0/ps_rd]
  connect_bd_net -net blk_mem_gen_1_doutb [get_bd_pins blk_mem_gen_1/doutb] [get_bd_pins cnn_0/out_rd]
  connect_bd_net -net blk_mem_gen_2_doutb [get_bd_pins blk_mem_gen_2/doutb] [get_bd_pins cnn_0/b_rd]
  connect_bd_net -net blk_mem_gen_3_doutb [get_bd_pins blk_mem_gen_3/doutb] [get_bd_pins cnn_0/w_rd]
  connect_bd_net -net blk_mem_gen_4_doutb [get_bd_pins blk_mem_gen_4/doutb] [get_bd_pins cnn_0/in_rd]
  connect_bd_net -net cnn_0_b_ra [get_bd_pins blk_mem_gen_2/addrb] [get_bd_pins cnn_0/b_ra]
  connect_bd_net -net cnn_0_b_we [get_bd_pins blk_mem_gen_2/web] [get_bd_pins cnn_0/b_we]
  connect_bd_net -net cnn_0_done [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins cnn_0/done]
  connect_bd_net -net cnn_0_in_ad [get_bd_pins blk_mem_gen_4/addrb] [get_bd_pins cnn_0/in_ad]
  connect_bd_net -net cnn_0_in_wd [get_bd_pins blk_mem_gen_4/dinb] [get_bd_pins cnn_0/in_wd]
  connect_bd_net -net cnn_0_in_we [get_bd_pins blk_mem_gen_4/web] [get_bd_pins cnn_0/in_we]
  connect_bd_net -net cnn_0_out_ad [get_bd_pins blk_mem_gen_1/addrb] [get_bd_pins cnn_0/out_ad]
  connect_bd_net -net cnn_0_out_wd [get_bd_pins blk_mem_gen_1/dinb] [get_bd_pins cnn_0/out_wd]
  connect_bd_net -net cnn_0_out_we [get_bd_pins blk_mem_gen_1/web] [get_bd_pins cnn_0/out_we]
  connect_bd_net -net cnn_0_ps_ra [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins cnn_0/ps_ra]
  connect_bd_net -net cnn_0_ps_we [get_bd_pins blk_mem_gen_0/web] [get_bd_pins cnn_0/ps_we]
  connect_bd_net -net cnn_0_r_en [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins blk_mem_gen_1/enb] [get_bd_pins blk_mem_gen_2/enb] [get_bd_pins blk_mem_gen_3/enb] [get_bd_pins blk_mem_gen_4/enb] [get_bd_pins cnn_0/r_en]
  connect_bd_net -net cnn_0_w_ra [get_bd_pins blk_mem_gen_3/addrb] [get_bd_pins cnn_0/w_ra]
  connect_bd_net -net cnn_0_w_we [get_bd_pins blk_mem_gen_3/web] [get_bd_pins cnn_0/w_we]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_bram_ctrl_3/s_axi_aclk] [get_bd_pins axi_bram_ctrl_4/s_axi_aclk] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins blk_mem_gen_1/clkb] [get_bd_pins blk_mem_gen_2/clkb] [get_bd_pins blk_mem_gen_3/clkb] [get_bd_pins blk_mem_gen_4/clkb] [get_bd_pins cnn_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_3/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_4/s_axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_reset [get_bd_pins blk_mem_gen_0/rstb] [get_bd_pins blk_mem_gen_1/rstb] [get_bd_pins blk_mem_gen_2/rstb] [get_bd_pins blk_mem_gen_3/rstb] [get_bd_pins blk_mem_gen_4/rstb] [get_bd_pins cnn_0/rst] [get_bd_pins rst_ps7_0_50M/peripheral_reset]

  # Create address segments
  create_bd_addr_seg -range 0x00008000 -offset 0xC0000000 [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00020000 -offset 0xC2000000 [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
  create_bd_addr_seg -range 0x00010000 -offset 0xC4000000 [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_2/S_AXI/Mem0] SEG_axi_bram_ctrl_2_Mem0
  create_bd_addr_seg -range 0x00020000 -offset 0xC6000000 [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_3/S_AXI/Mem0] SEG_axi_bram_ctrl_3_Mem0
  create_bd_addr_seg -range 0x00020000 -offset 0xC8000000 [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_4/S_AXI/Mem0] SEG_axi_bram_ctrl_4_Mem0
  create_bd_addr_seg -range 0x10000000 -offset 0x30000000 [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_1_Reg
