...
proc create_hier_cell_s00_entry_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.MSC006_RDATA_WIDTH {64} \
   CONFIG.MSC006_WDATA_WIDTH {64} \
   CONFIG.NUM_MSC {7} \
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net S_SC_AR_4 [get_bd_intf_pins m03_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M03_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_5 [get_bd_intf_pins m04_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M04_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_6 [get_bd_intf_pins m05_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M05_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_AW_4 [get_bd_intf_pins m03_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M03_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_5 [get_bd_intf_pins m04_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M04_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_6 [get_bd_intf_pins m05_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M05_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_4 [get_bd_intf_pins m03_nodes/S_SC_B] [get_bd_intf_pins m03_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_5 [get_bd_intf_pins m04_nodes/S_SC_B] [get_bd_intf_pins m04_sc2axi/M_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_6 [get_bd_intf_pins m05_nodes/S_SC_B] [get_bd_intf_pins m05_sc2axi/M_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_R_4 [get_bd_intf_pins m03_nodes/S_SC_R] [get_bd_intf_pins m03_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_5 [get_bd_intf_pins m04_nodes/S_SC_R] [get_bd_intf_pins m04_sc2axi/M_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_6 [get_bd_intf_pins m05_nodes/S_SC_R] [get_bd_intf_pins m05_sc2axi/M_SC_R]
  ...
  connect_bd_intf_net -intf_net S_SC_W_4 [get_bd_intf_pins m03_nodes/S_SC_W] [get_bd_intf_pins switchboards/M03_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_5 [get_bd_intf_pins m04_nodes/S_SC_W] [get_bd_intf_pins switchboards/M04_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_6 [get_bd_intf_pins m05_nodes/S_SC_W] [get_bd_intf_pins switchboards/M05_SC_W]
